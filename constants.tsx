...
export const DEITIES = [
  { name: 'Shree Ram', mantra: 'Om Ram Ramaya Namah' },
  { name: 'Shiva', mantra: 'Om Namah Shivaya' },
  { name: 'Krishna', mantra: 'Om Namo Bhagavate Vasudevaya' },
  { name: 'Hanuman', mantra: 'Om Hanumate Namah' },
  { name: 'Ganesha', mantra: 'Om Gan Ganapataye Namah' },
];
...
export const Icons = {
  ...
  Mala: (props: any) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><circle cx="12" cy="12" r="10"/><path d="M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20"/></svg>
  ),
  Chat: (props: any) => (
